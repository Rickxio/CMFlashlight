...
public class VerticalProgress extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            mStartResId = typedArray.getResourceId(R.styleable.verticalProgress_progress_start_color, R.color.start_color);
            mProgressBgColorId = typedArray.getResourceId(R.styleable.verticalProgress_progress_solid_color, Color.WHITE);
            mEndResId = typedArray.getResourceId(R.styleable.verticalProgress_progress_end_color, R.color.end_color);
            mBorderColorResId = typedArray.getResourceId(R.styleable.verticalProgress_progress_border_color, Color.TRANSPARENT);
